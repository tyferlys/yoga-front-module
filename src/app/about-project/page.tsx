        ...
        <div className="min-h-screen flex flex-col w-10/12 m-auto">
            <div className="mt-20 flex flex-col justify-center items-center">
                ...
                <div className="mt-6 lg:text-xl">
                    ...
                    Проект выполнена на базе <b>Саратовского государственного технического университета имени</b> <br/><br/>
                    ...
                    <div className="mb-4">
                        <b>Об авторах</b>
                        <li>
                            Руководитель проекта: - Шульга Татьяна Эриковна (г. Саратов), доктор физ.-мат. наук, профессор, инструктор йоги, йога
                            терапевт (yogasaratov.ru, https://vk.com/tatianashulgayoga)
                        </li>
                    </div>
                    <div className="mb-4">
                        <b>Эксперты: </b>
                        <li>
                            Бабкин Сергей Александрович (г. Москва), инструктор йоги и традиционных японских
                            боевых искусств, йогатерапевт и физический терапевт, практики и исследователь
                            традиционных систем медитации (индуистская и буддийская тантра). (https://heiho.ru/, https://vk.com/sergey_babkin9)
                        </li>
                        <li>
                            Шульга Игорь Иванович (г. Саратов), кандидат исторических наук, инструктор йоги,
                    ...
                    <div className="mb-4">
                        ...
                        <li>
                            Климов Денис, студент СГТУ имени Гагарина Ю., tyferly2003@gmail.com
                        </li>
                    </div>
                </div>
            </div>
